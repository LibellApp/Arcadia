...
$animal_images = [
    2 => "../src/images/WEBP/raie_a_points_bleus.webp",
    3 => "../src/images/WEBP/tortue.webp",
];
?>
...
<head>
    ...
    <title>Aquarium - Arcadia Zoo</title>
...
<header>
    ...
    <div class="content">
        <section class="habitat">
            ...
            <p>L'écosystème aquatique d'Arcadia est une merveille sous-marine où la diversité marine est célébrée dans des aquariums soigneusement conçus. Plongez dans un monde d'eau où les créatures marines cohabitent dans des environnements spectaculaires qui simulent leurs habitats naturels.</p>            <?php foreach ($animals as $animal): ?>
