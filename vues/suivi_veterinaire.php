...
try {
    ...
    $query = "SELECT animal.animal_id, animal.prenom, race.label AS espece, habitat.nom AS habitat
                FROM animal
            ...
            <?php foreach ($animals as $animal): ?>
                <div class=".animal-block">
                    <div class="animal-info">
                        ...
                        <form action="../controleurs/traiter_suivi_veterinaire.php" method="post">
                ...
                <hr> <!-- Ajout de la barre horizontale -->
            <?php endforeach; ?>
        </div>
    </div>
